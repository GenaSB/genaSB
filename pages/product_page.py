...
class Product_page(Base):
    """ Добавление выбранного ноутбука в корзину и проверка соответствия данных.
        ...
        Шаги:
            ...
            2. Нажимает кнопку добавления товара в корзину
            3. Переходит в корзину
            4. Проверяет заголовок страницы "Корзина"
            5. Сохраняет название товара в корзине
            6. Сохраняет итоговую цену в корзине
            7. Сравнивает название товара в корзине с названием выбранного ноутбука
            8. Сравнивает итоговую цену в корзине с ценой товара на странице ноутбука """
